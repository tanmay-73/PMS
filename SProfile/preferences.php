            ...
            <form action="pref.php" class="templatemo-login-form" method="post" enctype="multipart/form-data">
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">
                  ...
                  <input type="text" name="Fname" class="form-control" id="inputFirstName" placeholder="Hemang">
                </div>
                <div class="col-lg-6 col-md-6 form-group">
                  <label for="inputLastName">Last Name</label>
                  <input type="text"  name="Lname" class="form-control" id="inputLastName" placeholder="Shah">
                </div>

				<div class="col-lg-6 col-md-6 form-group">
                  <label for="PEN">PEN</label>
                  <input type="text" name="PEN" class="form-control" id="PEN" placeholder="180xxxxxxxxx" >
                </div>
